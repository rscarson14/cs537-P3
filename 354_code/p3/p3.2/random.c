...
int main(int argc, char* argv[]) {
   ...
   // plus max_allocs busy chunks
   // Total is (2*max_allocs)+1
   int region_size = ((max_allocs *  2) + 1) * max_chunk_size;
   ...
   *******************************************************************/
   ...
   assert(Mem_Init((region_size + slack),policy) == 0);
